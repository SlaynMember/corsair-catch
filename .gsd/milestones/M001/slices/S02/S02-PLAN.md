...
- [ ] **T01: Extract HUD to shared system, wire into Beach2 and Beach3** `est:40m`
...
- [ ] **T02: Fix CATCH button size and position in BattleScene** `est:20m`
...
- [ ] **T03: Fix mobile detection to use screen size heuristic** `est:20m`
...
- [ ] **T04: Verify TEAM/ITEMS panels end-to-end and fix any wiring issues** `est:30m`
