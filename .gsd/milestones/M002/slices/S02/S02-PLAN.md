...
- [x] **T01: Add player body sizing to Beach2 and Beach3** `est:15m`
...
- [x] **T02: Add per-frame walkable zone clamping to Beach3** `est:20m`
...
- [x] **T03: TMX collider cleanup pass for Beach3** `est:15m`
